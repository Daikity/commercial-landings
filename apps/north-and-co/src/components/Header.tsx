    ...
    >
      <div className="mx-auto flex max-w-[var(--shell-max)] items-center justify-between px-4 py-3 sm:px-6">
        ...
        <nav className="hidden items-center gap-6 md:flex" aria-label="Primary">
          ...
          <a href="#cases" className={`text-sm font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] ${focusRing}`}>
            Cases
          </a>
          <a href="#process" className={`text-sm font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text)] ${focusRing}`}>
            Process
          </a>
          <a
            href="#engagement"
