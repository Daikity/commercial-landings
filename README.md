...
Этап: **Batch 2 / KAIRO ✅** — следующий Batch 3 (NORTHLINE).  
Demos: `/demos/maison-crumb/`, `/demos/noir-patisserie/`, `/demos/ferment/`, `/demos/aura-studio/`, `/demos/mona-skin/`, `/demos/kairo/`.
